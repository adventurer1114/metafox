...
import { APP_GROUP, DECLINED, MENU_MY_CONTENT_NAME } from '@metafox/group';
...
const DeclinedPost = ({
  ...
  const itemMenu: MenuItemShape =
    menus[menus.findIndex(item => item.name === DECLINED)];
    ...
    <Block {...rest}>
      ...
      <BlockContent>
        <ListView
          ...
          emptyPageProps={{
            title: i18n.formatMessage({ id: 'no_declined_post' }),
            image: itemMenu.icon
          }}
        />
      </BlockContent>
