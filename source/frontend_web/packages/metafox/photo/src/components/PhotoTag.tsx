...
import { ItemExtraShape, LineIcon } from '@metafox/ui';
...
const LinkStyled = styled(Link, { name, slot: 'LinkStyled' })(({ theme }) => ({
  color:
...
export default function PhotoTag({
  ...
  return (
    ...
    >
      ...
      >
        {user && !isTypePreview ? (
          <LinkStyled to={`/${user.user_name}`} children={user.full_name} />
        ) : (
