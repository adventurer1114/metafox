...
const BlockContentWrapperStyled = styled(Box, { name: 'BlockContent' })(
  ({ theme }) => ({
    display: 'flex',
...
const MainContentStyled = styled(Box, { name: 'MainContentStyled' })(
  ({ theme }) => ({
    flex: 1,
    ...
    <Block testid="activityGetStarted" {...rest}>
      ...
      <BlockContent>
        <BlockContentWrapperStyled>
          ...
          <BoxImage>
            <ActivityImage src={assetUrl('activitypoint.get_started')} />
          </BoxImage>
        </BlockContentWrapperStyled>
      </BlockContent>
    </Block>
