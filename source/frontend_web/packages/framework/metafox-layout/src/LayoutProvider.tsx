 ...
 * name: LayoutProvider
 */
import { MFOX_BUILD_TYPE, useGlobal } from '@metafox/framework';
...
export default function LayoutProvider({ children }: LayoutProviderProps) {
  ...
  const { constants, layoutBackend, jsxBackend, LayoutPreviewContainer } =
    manager;
  ...
  const disableHelmet = MFOX_BUILD_TYPE === 'installation';
