...
import snippets from '@metafox/react-app/bundle-web/theme.style.editor';
    ...
    <>
      ...
      <Tooltip title={i18n.formatMessage({ id: 'help' })}>
        <IconButton size="small">
          <LinkTo
            target="_blank"
            href="https://docs.phpfox.com/display/MFMAN/Appearances%2C+Layout+and+Themes"
            underline="none"
          >
...
export default function LayoutEditor() {
  const { useLoggedIn, eventCenter, i18n, useLayout, layoutBackend, dispatch } =
    useGlobal();
