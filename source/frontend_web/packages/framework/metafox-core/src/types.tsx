...
export type GridItemDividerVariant = 'top' | 'none' | 'bottom';
...
export interface BlockViewProps extends BlockStyleProps, ConfiguredLayout {
  ...
  blockProps?: {
    blockStyle?: { variant?: string; sx: SxProps };
    headerStyle?: { sx: SxProps; dividerVariant: string };
    titleStyle?: { sx: SxProps; component?: React.ElementType };
    contentStyle?: { sx: SxProps };
    footerStyle?: { sx: SxProps; dividerVariant: string };
  };
  contentType?: string;
  themeId?: ThemeId;
  testid?: string;
...
export type StatusComposerRef = {
  ...
  setAttachments(type: string, name: string, item: Record<string, any>): void;
...
export type FileItemStatus = 'remove' | 'create' | 'update';
