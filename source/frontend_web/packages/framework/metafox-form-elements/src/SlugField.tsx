...
import { camelCase, isNil, isObject, isString } from 'lodash';
...
const TextFormField = ({
  ...
  React.useEffect(() => {
    if (
      ...
      mappingField in formik.values &&
      isString(formik.values[mappingField])
    ) {
      const data = formik.values[mappingField];

      setValue(toSlugifyLowerNonAccent(data, separator));
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [mappingField, formik.values[mappingField]]);
