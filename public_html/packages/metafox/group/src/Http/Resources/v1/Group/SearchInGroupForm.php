 ...
 * @preload 1
 */
class SearchInGroupForm extends AbstractForm
{
    ...
    {
        $collection = resolve(MenuItemRepositoryInterface::class)
            ->getMenuItemByMenuName('group.searchWebCategoryMenu', 'web', true);
