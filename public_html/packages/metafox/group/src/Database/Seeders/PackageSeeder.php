...
class PackageSeeder extends Seeder
{
     ...
     */
    private ExampleRuleRepositoryInterface $groupRuleExampleRepository;
     ...
     * @param  ExampleRuleRepositoryInterface  $groupRuleExampleRepository
     */
    public function __construct(
        CategoryRepositoryInterface $categoryRepository,
        ExampleRuleRepositoryInterface $groupRuleExampleRepository
    ) {
