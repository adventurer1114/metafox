...
use MetaFox\Event\Database\Factories\HostInviteFactory;
use MetaFox\Event\Notifications\HostInvite as InviteNotification;
 ...
 */
class HostInvite extends Model implements Entity, IsNotifyInterface, HasUrl
{
    use HasEntity;
    use HasOwnerMorph;
    use HasUserMorph;
    ...
    public const ENTITY_TYPE = 'event_host_invite';
    ...
    protected $table = 'event_host_invites';
    ...
    protected static function newFactory(): HostInviteFactory
    {
        return HostInviteFactory::new();
    }
