...
{
    protected string $type = 'event_invite';
    ...
    public function toMail(IsNotifiable $notifiable): MailMessage
    {
        ...
        $subject = $this->localize('event::phrase.mail.event_invite_subject', [
            'user' => $userFullName,
        ]);

        $text = $this->localize('event::phrase.mail.event_invite_text', [
            'user' => $userFullName,
        ]);
    ...
    public function callbackMessage(): ?string
    {
        ...
        return $this->localize('event::notification.user_full_name_invited_you_to_the_event_title', [
