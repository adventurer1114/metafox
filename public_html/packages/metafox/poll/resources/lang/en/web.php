...
return [
    ...
    'added_a_poll' => '{appName, select,
        feed {{
            parentType, select,
                group {added a poll in <profile>profile</profile>}
                page {posted a poll in <profile>profile</profile>}
                other {added a poll}
        }}
    ...
    'voting_for_the_poll_was_closed' => 'Voting on the poll was closed.',
];
